...
async function imageToWebp(media) {
    ...
    await new Promise((resolve, reject) => {
        ff(tmpFileIn)
            ...
            "libwebp",
            "-vf",
            "scale='scale=512:512:flags=lanczos:force_original_aspect_ratio=decrease,fps=15, pad=512:512:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse"
        ])
            .toFormat("webp")
            .save(tmpFileOut);
    });
