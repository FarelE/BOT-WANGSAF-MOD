...
async function imageToWebp(media) {
    ...
    await new Promise((resolve, reject) => {
        ff(tmpFileIn)
            ...
            "libwebp",
            "-vf",
            "scale='min(100,iw)':min'(100,ih)':force_original_aspect_ratio=decrease,fps=15, pad=100:100:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse"
        ])
            .toFormat("webp")
            .save(tmpFileOut);
    });
